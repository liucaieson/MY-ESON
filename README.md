...
Stub_status指令:该指令用于了解Nginx当前状态的当前状态，如当前 的活动连接，接受和处理当前读/写/等待连接的总数 Sub_filter指令:它用于搜索和替换响应中的内容，并快速修复陈旧的 数据
### nginx.conf 文件的结构
...
[nginx](https://juejin.cn/post/6844903944267759624#heading-14)
...
删除一个字符
替换一个字符
[编辑距离](https://zhuanlan.zhihu.com/p/89946196)

### 判断二叉树是否相等
[判断二叉树是否相等](http://www.cxyzjd.com/article/u011578734/106717988)

### 洗牌算法，用什么办法把一副牌洗乱，打乱一个54长度的数组
[洗牌算法](https://juejin.cn/post/6984925268754317320)
